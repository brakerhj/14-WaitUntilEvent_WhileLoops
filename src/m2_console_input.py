...
def double_a_float():
    ...
    # -------------------------------------------------------------------------
    x = float(input('Double this number: '))
    print(2 * x)
...
def print_an_integer_many_times():
    ...
    #   The testing code is already written for you (above).
    # -------------------------------------------------------------------------
    x = int(input('Repeat doubled number: '))
    for k in range(x):
        print(2 * x)
...
def print_an_integer_many_times_on_one_row():
    ...
    # -------------------------------------------------------------------------
    x = int(input('Another doubled number: '))
    print(x * str(x))
...
def input_it_all():
    ...
    #   The testing code is already written for you (above).
    # -------------------------------------------------------------------------
    flo = float(input('Pick a decimal number: '))
    inter = int(input('Pick a whole number: '))
    string = input("What's your favorite word? ")
